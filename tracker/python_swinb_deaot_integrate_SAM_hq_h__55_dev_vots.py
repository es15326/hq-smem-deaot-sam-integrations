...
while True:
    ...
    elapsed_time = end_time - start_time + end_time1 - start_time1

    with open('/cluster/VAST/civalab/results/development_data_2024/my_method_timing_dev_vots.txt', 'a') as f:
