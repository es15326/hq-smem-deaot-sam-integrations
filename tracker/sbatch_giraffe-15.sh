...
## labels and outputs
#SBATCH --job-name=giraffe-15
#SBATCH --output=giraffe-%j.out  # %j is the unique jobID
...
python python_swinb_dm_deaot_integrate_SAM_hq_h_imad_59_visualize_save_gt_masks.py giraffe-15
