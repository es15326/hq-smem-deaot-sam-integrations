...
while True:
    ...
    predictor.save_image_embedding(f'{embd_dir}/embd')
    start_time = time.time()
    predictor.load_image_embedding(f'{embd_dir}/embd')
    ...
    with open('/cluster/VAST/civalab/results/VOTS_2024/parallel_v3.txt', 'a') as f:
