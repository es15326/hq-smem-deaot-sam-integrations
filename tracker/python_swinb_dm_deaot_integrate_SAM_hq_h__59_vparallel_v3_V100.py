...
while True:
    ...
    predictor.save_image_embedding(f'{embd_dir}/embd_V100')
    start_time = time.time()
    predictor.load_image_embedding(f'{embd_dir}/embd_V100')
    ...
    with open('/cluster/VAST/civalab/results/VOTS_2024/parallel_v3_V100.txt', 'a') as f:
