...
# model_type = "vit_h"
sam_checkpoint = "/home/esdft/data/sam_hq_vit_l.pth"
model_type = "vit_l"
...
while True:
    ...
    _pred_label = F.interpolate(pred_label,
                                size=tracker.engine.input_size_2d,
                                mode="nearest")
    print(f'{_pred_label.shape = } <============= Outside')

    tracker.engine.update_memory(_pred_label)
